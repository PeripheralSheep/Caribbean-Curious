...
define('CONTACTFORM_FROM_NAME', 'Contact Form on Caribbean Curious');
...
define('CONTACTFORM_TO_ADDRESS', 'caribbeancurious@gmail.com');
define('CONTACTFORM_TO_NAME', 'Caribbean Curious');

// The details of your SMTP service, e.g. Gmail.
define('CONTACTFORM_SMTP_HOSTNAME', 'smtp.gmail.com');
define('CONTACTFORM_SMTP_USERNAME', 'caribbeancurious@gmail.com');
define('CONTACTFORM_SMTP_PASSWORD', 'axjrifzhrwkrxbnc');

// The reCAPTCHA credentials for your site. You can get these at https://www.google.com/recaptcha/admin
define('CONTACTFORM_RECAPTCHA_SITE_KEY', '6LeWpSccAAAAAHUUsmbMwCYw6OxQg_66bRRfGGaG');
define('CONTACTFORM_RECAPTCHA_SECRET_KEY', '6LeWpSccAAAAAPn1RNlN5UiT2V9SwAdlZOINgxpy');
